              ...
              child: Center(
                child: RichText(
                  text: const TextSpan(
                    children: [
                      WidgetSpan(
                        child: Icon(Icons.generating_tokens_outlined, size: 18,
                          color: Colors.green,),
                      ),
                      WidgetSpan(
                ...
                child: RichText(
                  text: const TextSpan(
                    children: [
                      ...
                      WidgetSpan(
                        child: Icon(Icons.arrow_downward_outlined, size: 18,
                          color: Colors.orange,),
                      ),
                      // TextSpan(
                      //   text: " Over 4.5  |",
                ...
                child:Column(
                  children: [
                    ...
                    const Padding(
                      ...
                      child: Text("2 McAloo Tikki Burgers + 2 Fries(L)",
